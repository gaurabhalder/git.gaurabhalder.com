...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pixel.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pixels.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="pixel_tag">{{ trans('cruds.pixel.fields.pixel_tag') }}</label>
                <input class="form-control {{ $errors->has('pixel_tag') ? 'is-invalid' : '' }}" type="text" name="pixel_tag" id="pixel_tag" value="{{ old('pixel_tag', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_analytic') ? 'is-invalid' : '' }}" type="text" name="google_analytic" id="google_analytic" value="{{ old('google_analytic', '') }}">
