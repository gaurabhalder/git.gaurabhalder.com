...
@section('content')
          ...
          <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-10">
            <div class="section-heading-14 text-center">
              ...
              <p>We are an industry-leading company that values honesty, integrity, and efficiency. Building
                quality products and caring for the users are what made us stand out since the beginning.</p>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="inner-about-bg-area">
              ...
              <div class="content">
                <p>“We strive to work closely together with our customers in solving their problems. We value
                  honesty, integrity, and efficiency”</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="icon-content-area d-md-flex align-items-center text-center text-md-start">
              ...
              <div class="content">
                <p>We’re a team of highly skilled professionals with years of experience in different fields
                  vowed to revolutionize
                  the people’s web experience.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Counter Area -->
    <div class="counter-area-l8 counter-area-inner-about-us">
      <div class="container">
        <div class="row counter-area-l8-items justify-content-center text-center text-lg-start">
          <div class="col-xl-3 col-lg-4 col-sm-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
            <div class="counter-wrapper d-flex justify-content-center">
              <div class="count-number">
                <h2><span class="counter">429</span></h2>
              </div>
              <div class="count-content">
                <p>Exclusive<br> Clients</p>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 col-sm-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
    ...
    <!-- Team Area -->
    <div class="about-area-team">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
            <div class="section-heading-14 text-center">
              <h2>Meet The Minds Shaping Our Industry</h2>
            </div>
          </div>
        </div>
        <div class="row justify-content-center about-area-team-items">
